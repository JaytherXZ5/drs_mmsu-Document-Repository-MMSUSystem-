...
function classList(props) {
  ...
  }, _defineProperty2(_classes, "fa-".concat(props.size), props.size !== null), _defineProperty2(_classes, "fa-rotate-".concat(props.rotation), props.rotation !== null), _defineProperty2(_classes, "fa-pull-".concat(props.pull), props.pull !== null), _defineProperty2(_classes, "fa-swap-opacity", props.swapOpacity), _defineProperty2(_classes, "fa-bounce", props.bounce), _defineProperty2(_classes, "fa-shake", props.shake), _defineProperty2(_classes, "fa-beat", props.beat), _defineProperty2(_classes, "fa-fade", props.fade), _defineProperty2(_classes, "fa-beat-fade", props.beatFade), _defineProperty2(_classes, "fa-flash", props.flash), _defineProperty2(_classes, "fa-spin-pulse", props.spinPulse), _defineProperty2(_classes, "fa-spin-reverse", props.spinReverse), _classes);
...
var FontAwesomeIcon = defineComponent({
  ...
  setup: function setup(props, _ref2) {
    ...
    var renderedIcon = computed(function() {
      return icon2(icon$1.value, _objectSpread22(_objectSpread22(_objectSpread22(_objectSpread22({}, classes.value), transform.value), mask.value), {}, {
        symbol: props.symbol,
        title: props.title
      }));
    });
