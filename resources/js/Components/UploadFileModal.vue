                                                    ...
                                                    <div class="modal-content flex flex-col px-4">
                                                        ...
                                                        <div class="px-4 flex flex-row w-full justify-between">
                                                            ...
                                                            <div class="flex flex-row">
                                                                <button  type="submit" class="ml-2 border-2 w-20 h-10 rounded-lg mb-2 bg-violet-500 shadow-left-side text-white hover:scale-110  transition-transform duration-300">Upload</button>
                                                                <button  @click.prevent="clear" class="ml-2 border-2 w-20 h-10 rounded-lg mb-2 bg-violet-500 shadow-left-side text-white hover:scale-110  transition-transform duration-300">Clear</button>
