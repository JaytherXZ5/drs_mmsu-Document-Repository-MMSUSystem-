<template>
    <img src="../../images/profile.png" class="h-full border-green-600 shadow-inset border-2 rounded-full " alt="">
    <h1 class="font-montserrat text-gray-600 w-[60%] truncate ">{{ user.name }}</h1>

    <div class=" ml-3 text-right ">
       

       <Menu as="div" class="z-10 text-left flex flex-row">
         ...
         >
           <MenuItems
             class=" absolute right-0 mt-2 w-[150px] origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-green-600 focus:outline-none"
           >
             <div class="px-1 py-1">
