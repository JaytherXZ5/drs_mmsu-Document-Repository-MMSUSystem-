                        ...
                        <div v-show="area_modalActive" class="modal-inner">
                            ...
                            <div class="modal-content flex flex-col pt-8 px-10">
                                ...
                                <Menu as="div" class="relative inline-block text-left w-[60%]">
                                    ...
                                    >
                                    <MenuItems
                                        class=" border-2 border-green-400 z-50 absolute ml-10 left-10 mt-2 w-[250px] origin-top-right divide-y divide-gray-100 rounded-md bg-gray-100 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
                                    >
                                        <div class="px-1 py-1">
                                        ...
                                        <MenuItem v-slot="{ active }">
                                            ...
                                            :class="[
                                                active ? 'bg-violet-500 text-white' : 'text-gray-900',
                                                'group flex w-full items-center text-black rounded-t-md  py-2 text-sm',
                                            ]"
                                            >
